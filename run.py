...
def get_player_name():
    player_name = input("Hello, please enter your name, if nothing is entered we will call you player one:").strip().lower()
    #validation....
    if player_name == "":
...
def main():
    ...
    while True:
        ...
        ask_at_end = input('Would you like another game? Hit any key to go again or type n or no to stop').strip().lower()
        answer_no = ['n', 'no']
